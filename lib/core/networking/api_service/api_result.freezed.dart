...
abstract class $ServiceResultCopyWith<T, $Res> {
  factory $ServiceResultCopyWith(
          ServiceResult<T> value, $Res Function(ServiceResult<T>) then) =
...
abstract class Success<T> implements ServiceResult<T> {
...
class _$FailureImpl<T> implements Failure<T> {
  ...
  @override
  String toString() {
    return 'ServiceResult<$T>.failure(errorHandler: $errorHandler)';
  }
...
abstract class Failure<T> implements ServiceResult<T> {
